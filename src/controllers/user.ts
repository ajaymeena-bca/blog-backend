...
import {NewUserRequestBody, UpdateUserRquestBody} from '../types/types.js'
...
export const updateUser = TryCatch(async(req:Request<{},{},UpdateUserRquestBody>,res,next)=>{
       ...
       let setterObj:UpdateUserRquestBody = {};

       if(username) setterObj.username = username;
       if(eamil) setterObj.eamil = eamil;
       if(gender) setterObj.gender = gender;
